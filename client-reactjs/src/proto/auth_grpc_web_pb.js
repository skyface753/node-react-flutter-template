 ...
 *   !proto.template.DefaultAuthResponse>}
 */
const methodDescriptor_AuthService_Login = new grpc.web.MethodDescriptor(
  ...
  proto.template.DefaultAuthResponse.deserializeBinary
);
 ...
 *     call metadata
 * @param {function(?grpc.web.RpcError, ?proto.template.DefaultAuthResponse)}
 *     callback The callback function(error, response)
 * @return {!grpc.web.ClientReadableStream<!proto.template.DefaultAuthResponse>|undefined}
 ...
 * @param {?Object<string, string>=} metadata User defined
 *     call metadata
 * @return {!Promise<!proto.template.DefaultAuthResponse>}
 ...
 * @const
 * @type {!grpc.web.MethodDescriptor<
 *   !proto.template.RegisterRequest,
 *   !proto.template.DefaultAuthResponse>}
 */
const methodDescriptor_AuthService_Register = new grpc.web.MethodDescriptor(
  ...
  proto.template.DefaultAuthResponse,
  /**
   * @param {!proto.template.RegisterRequest} request
   * @return {!Uint8Array}
   */
  function(request) {
    return request.serializeBinary();
...
/**
 * @param {!proto.template.RegisterRequest} request The
 *     request proto
 * @param {?Object<string, string>} metadata User defined
 *     call metadata
 * @param {function(?grpc.web.RpcError, ?proto.template.DefaultAuthResponse)}
 ...
 *     The XHR Node Readable Stream
 */
proto.template.AuthServiceClient.prototype.register =
    function(request, metadata, callback) {
  return this.client_.rpcCall(this.hostname_ +
      '/template.AuthService/Register',
      request,
 ...
 *     Promise that resolves to the response
 */
proto.template.AuthServicePromiseClient.prototype.register =
    function(request, metadata) {
  return this.client_.unaryCall(this.hostname_ +
      '/template.AuthService/Register',
      request,
...
const methodDescriptor_AuthService_Status = new grpc.web.MethodDescriptor(
  ...
  proto.template.StatusResponse.deserializeBinary
);
 ...
 * @param {?Object<string, string>} metadata User defined
 *     call metadata
 * @param {function(?grpc.web.RpcError, ?proto.template.StatusResponse)}
 *     callback The callback function(error, response)
 * @return {!grpc.web.ClientReadableStream<!proto.template.StatusResponse>|undefined}
 *     The XHR Node Readable Stream
 */
 ...
 * @param {?Object<string, string>=} metadata User defined
 *     call metadata
 * @return {!Promise<!proto.template.StatusResponse>}
 *     Promise that resolves to the response
 */
