...
function deserialize_template_DefaultAuthResponse(buffer_arg) {
  return grpc$proto_auth_pb.DefaultAuthResponse.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_template_DisableTOTPRequest(arg) {
  if (!(arg instanceof grpc$proto_auth_pb.DisableTOTPRequest)) {
...
function deserialize_template_DisableTOTPRequest(buffer_arg) {
  return grpc$proto_auth_pb.DisableTOTPRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_template_DisableTOTPResponse(arg) {
  if (!(arg instanceof grpc$proto_auth_pb.DisableTOTPResponse)) {
...
function deserialize_template_DisableTOTPResponse(buffer_arg) {
  return grpc$proto_auth_pb.DisableTOTPResponse.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_template_EnableTOTPRequest(arg) {
  if (!(arg instanceof grpc$proto_auth_pb.EnableTOTPRequest)) {
...
function deserialize_template_EnableTOTPRequest(buffer_arg) {
  return grpc$proto_auth_pb.EnableTOTPRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_template_EnableTOTPResponse(arg) {
  if (!(arg instanceof grpc$proto_auth_pb.EnableTOTPResponse)) {
...
function deserialize_template_EnableTOTPResponse(buffer_arg) {
  return grpc$proto_auth_pb.EnableTOTPResponse.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_template_LoginRequest(arg) {
  if (!(arg instanceof grpc$proto_auth_pb.LoginRequest)) {
...
function deserialize_template_LoginRequest(buffer_arg) {
  return grpc$proto_auth_pb.LoginRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_template_LogoutRequest(arg) {
  if (!(arg instanceof grpc$proto_auth_pb.LogoutRequest)) {
...
function deserialize_template_LogoutRequest(buffer_arg) {
  return grpc$proto_auth_pb.LogoutRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_template_LogoutResponse(arg) {
  if (!(arg instanceof grpc$proto_auth_pb.LogoutResponse)) {
...
function deserialize_template_LogoutResponse(buffer_arg) {
  return grpc$proto_auth_pb.LogoutResponse.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_template_RefreshTokenRequest(arg) {
  if (!(arg instanceof grpc$proto_auth_pb.RefreshTokenRequest)) {
...
function deserialize_template_RefreshTokenRequest(buffer_arg) {
  return grpc$proto_auth_pb.RefreshTokenRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_template_RegisterRequest(arg) {
  if (!(arg instanceof grpc$proto_auth_pb.RegisterRequest)) {
...
function deserialize_template_RegisterRequest(buffer_arg) {
  return grpc$proto_auth_pb.RegisterRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_template_StatusRequest(arg) {
  if (!(arg instanceof grpc$proto_auth_pb.StatusRequest)) {
...
function deserialize_template_StatusRequest(buffer_arg) {
  return grpc$proto_auth_pb.StatusRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_template_StatusResponse(arg) {
  if (!(arg instanceof grpc$proto_auth_pb.StatusResponse)) {
...
function deserialize_template_StatusResponse(buffer_arg) {
  return grpc$proto_auth_pb.StatusResponse.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_template_VerifyTOTPRequest(arg) {
  if (!(arg instanceof grpc$proto_auth_pb.VerifyTOTPRequest)) {
...
function deserialize_template_VerifyTOTPRequest(buffer_arg) {
  return grpc$proto_auth_pb.VerifyTOTPRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_template_VerifyTOTPResponse(arg) {
  if (!(arg instanceof grpc$proto_auth_pb.VerifyTOTPResponse)) {
...
function deserialize_template_VerifyTOTPResponse(buffer_arg) {
  return grpc$proto_auth_pb.VerifyTOTPResponse.deserializeBinary(new Uint8Array(buffer_arg));
}
...
var AuthServiceService = exports.AuthServiceService = {
  login: {
    ...
    requestType: grpc$proto_auth_pb.LoginRequest,
    responseType: grpc$proto_auth_pb.DefaultAuthResponse,
  ...
  refreshToken: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: grpc$proto_auth_pb.RefreshTokenRequest,
    responseType: grpc$proto_auth_pb.DefaultAuthResponse,
  ...
  logout: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: grpc$proto_auth_pb.LogoutRequest,
    responseType: grpc$proto_auth_pb.LogoutResponse,
  ...
  register: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: grpc$proto_auth_pb.RegisterRequest,
    responseType: grpc$proto_auth_pb.DefaultAuthResponse,
  ...
  status: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: grpc$proto_auth_pb.StatusRequest,
    responseType: grpc$proto_auth_pb.StatusResponse,
  ...
  disableTOTP: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: grpc$proto_auth_pb.DisableTOTPRequest,
    responseType: grpc$proto_auth_pb.DisableTOTPResponse,
  ...
  enableTOTP: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: grpc$proto_auth_pb.EnableTOTPRequest,
    responseType: grpc$proto_auth_pb.EnableTOTPResponse,
  ...
  verifyTOTP: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: grpc$proto_auth_pb.VerifyTOTPRequest,
    responseType: grpc$proto_auth_pb.VerifyTOTPResponse,
